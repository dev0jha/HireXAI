...
export const NeutralHeroBackground = ({
  className,
}: {
  className?: string;
}) => {
  ...
  return (
    ...
    >
      {/* Background Colors */}
      <div className="absolute inset-0 -z-10 bg-white transition-colors duration-300 dark:bg-black" />
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-gray-100/50 via-white to-white transition-colors duration-300 dark:from-zinc-900/20 dark:via-black dark:to-black" />
