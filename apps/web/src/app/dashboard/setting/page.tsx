          ...
          <Card className="p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Allow recruiters to view your profile and send requests</p>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Receive email alerts for new contact requests</p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Get notified when your score changes</p>
                </div>
                <Switch defaultChecked />
              </div>
            </div>
